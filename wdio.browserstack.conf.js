...
export const config = {
  ...
  baseUrl: `https://lis-journey-tests.${process.env.ENVIRONMENT}.cdp-int.defra.cloud`,
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `lis-journey-tests-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `lis-journey-tests-${process.env.ENVIRONMENT}`
        },
